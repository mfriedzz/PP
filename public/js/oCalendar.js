...
$.fn.oCalendar = function(options) {
        ...
        var html = '<div class="container">\
                        ...
                        <div style="float:right; width:'+(w-180)+'px;">\
                            <div class="bigCalHeader">\
                                ...
                                <div class="viewChanges">\
                                    <a href="javascript:void(0);" class="dayShow" title="dayView">'+dayStr+'</a>\
                                    <a href="javascript:void(0);" class="weekShow" title="weekView" rel="up">'+weekStr+'</a>\
                                    <a href="javascript:void(0);" class="monthShow" title="monthView">'+monthStr+'</a>\
    ...
    function preloadImages(){
        var back = new Image();
        back.src = "img/back6.png";
        
        var pic2= new Image();
        pic2.src ="img/close.png";

        var pic3= new Image();
        pic3.src = "img/delete.png";

        var pic4= new Image();
        pic4.src = "img/edit.png";
    }
    ...
    function addToDom(elem, myEvent){
        ...
        if(view == 'month'){
            ...
            if(divSize < 2){
                html += '<div id="event-'+myEvent.id+'" class="event">\
